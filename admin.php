			...
			<body onload="loadProfil()">
				...
				<div class="contener">
							...
							while($Report=$Report_tap->fetch()){ 
								...
								if($AccountReport=$AccountReport_tab->fetch()){
									...
									<div class="MsgReported">
										<div class="profilReport" id="Sender" onclick="loadknownProfil('<?php echo $Report['IdAccount'];?>','Account')">
											<img class="profilPicture" src="img/<?php echo $Report['IdAccount']."/".$AccountReport['ProfilPictureFile'];?>">
											<div class="pseudo"><?php echo $AccountReport['Pseudo']; ?></div>
										</div>
									</div>
								<?php }
							}
						...
						<?php 
							...
							while($Report=$Report_tap->fetch()){
								...
								if($MsgReport=$MsgReport_tab->fetch()){
									...
									?>
									<div class="MsgReported">
										<div onclick="loadknownProfil('<?php echo $MsgReport['IdRecipient'];?>','Messagerie','<?php echo $Sender['Pseudo']; ?>','<?php echo $MsgReport['IdMessage'];?>')">
										<?php 
					...
					<div class="reglage">
						...
						<div id="boutonSuppr" onclick="rmAccount()">
							Supprimer Compte
						</div>
					</div>
